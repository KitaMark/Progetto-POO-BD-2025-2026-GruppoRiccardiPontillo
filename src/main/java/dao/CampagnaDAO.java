...
public interface CampagnaDAO {
    ...
    void leggiListaPersonaggi(List<Personaggio> lista, boolean isPg); //legge lista PG o PnG relativa alla Campagna.
    void leggiGiocatori(List<Giocatore> partecipanti);
    //per ora
}
